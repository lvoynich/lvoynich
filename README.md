...
* 📚 **Modern Data Stack Transition:** Actively migrating my deep Oracle enterprise engineering experience into modern cloud environments by completing the foundational **dbt (Data Build Tool)** and **Snowflake** ecosystem pipelines.
* 🛡️ **Governed Engineering:** Designing open-source code repositories that balance clean analytical modeling with rigid corporate auditing and vulnerability tracking principles.
